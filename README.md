...
# 🎮 Ultrapool — Community Edition

**A standalone Community Edition of the billiards simulation Ultrapool.**
...
Ultrapool is a cue sports simulation featuring realistic ball physics, spin control and multiple pool disciplines. This Community Edition is a standalone build containing the full game in a self-contained package. No storefront account or additional software is required, and the game is ready to play immediately after installation.

Players who want a complete offline billiards experience on Windows without a storefront account or extra setup.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4195110/31cd071b6f701758cd1bd334d7e4bdac5a8b573b/ss_31cd071b6f701758cd1bd334d7e4bdac5a8b573b.1920x1080.jpg?t=1787913285" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4195110/1eb2794afa891a7af1c3dd247bd3105e951eb8c3/ss_1eb2794afa891a7af1c3dd247bd3105e951eb8c3.1920x1080.jpg?t=1787913285" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4195110/f1f4fa65a9789bb031ccdf3dc642eba01640a92b/ss_f1f4fa65a9789bb031ccdf3dc642eba01640a92b.1920x1080.jpg?t=1787913285" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- 🎱 **Realistic Physics** — Precise ball collision, spin and cushion rebound simulation for an authentic cue sports feel.
- 🎮 **Multiple Game Modes** — 8-ball, 9-ball and practice table modes included in the base package.
- 🖥️ **Offline Play** — Full single-player experience that runs entirely without an internet connection.
- 🌐 **LAN Support** — LAN and direct P2P connection supported for local matches between players.
- 🎨 **Table Customization** — Choose cue designs, felt colors and table environments to suit your style.
- 🏆 **Tournament Ladder** — Compete through AI tournaments across several difficulty tiers.
- ⚙️ **Adjustable Difficulty** — Tune opponent skill from beginner to professional level at any time.
- 🕹️ **Input Flexibility** — Play with mouse, keyboard or gamepad, with configurable controls.
- 💾 **Lightweight Footprint** — Small install size and modest hardware demands for older systems.
- 📦 **Self-Contained Package** — Independent release with all content included — no additional downloads needed.

- **Compression:** Lossless
- **Install Time:** ~2 minutes on SSD, ~4 on HDD
- **Recoding:** none
- **Selective Download:** Not applicable — single self-contained package

---

## 📦 DLCs Included

- All released content included
...
| **RAM** | 4 GB | 8 GB |
| **Graphics** | DirectX 11 compatible GPU with 1 GB VRAM | NVIDIA GeForce GTX 750 Ti or better |
| **Storage** | 2 GB available space | 2 GB on SSD |
| **Additional** | DirectX 11 | DirectX 11, sound device |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\Ultrapool\Saved`
